        ...
        <div className='max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5 text-center sm:text-left'>
          <div>
            <div onClick={()=>navigate("/")} className='flex items-center gap-2.5'>
                    ...
                    <h1 className='font-bold text-xl text-gray-100 leading-none'>KIMAI{" "}<span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-emerald-500'>AI</span></h1>
          ...
          <p className='text-gray-500 text-sm'>
            © {new Date().getFullYear()} KIMAI. All rights reserved.
          </p>
